#!/usr/bin/env python3
# targets.py - Daftar 33+ target OTP WhatsApp (Gabungan)
...
TARGETS = [
    # ========== HANDLER SPESIFIK (dari kode pertama) ==========
    {'name': 'HRS-BRE', 'post_type': 'hrsbre', 'number_fmt': fmt_08},
    {'name': 'EraFone', 'post_type': 'erafone', 'number_fmt': lambda p: p},
    {'name': 'PlanetBan', 'post_type': 'planetban', 'number_fmt': fmt_08},
    {'name': 'TuneUp', 'post_type': 'tuneup', 'number_fmt': fmt_08},
    {'name': 'HashMicro', 'post_type': 'hashmicro', 'number_fmt': fmt_phone_only},
    {'name': 'Klook', 'post_type': 'klook', 'number_fmt': fmt_plus},
    {'name': 'Internet Rakyat', 'post_type': 'internetrakyat', 'number_fmt': fmt_08},
    {'name': 'Ultramilk', 'post_type': 'ultramilk', 'number_fmt': lambda p: p},
    {'name': 'Kaniva', 'post_type': 'kaniva', 'number_fmt': fmt_08},
    {'name': 'Jembatani', 'post_type': 'jembatani', 'number_fmt': fmt_08},
    {'name': 'RCX', 'post_type': 'rcx', 'number_fmt': fmt_08},
    {'name': 'Sahabat Teknisi', 'post_type': 'sahabatteknisi', 'number_fmt': fmt_08},
    {'name': 'Auto2000', 'post_type': 'auto2000', 'number_fmt': fmt_08},
    {'name': 'Astra Daihatsu', 'post_type': 'astra_daihatsu', 'number_fmt': fmt_plus},
    {'name': 'Royal Canin', 'post_type': 'royal_canin', 'number_fmt': fmt_plus},
    {'name': 'Watsons', 'post_type': 'watsons', 'number_fmt': fmt_phone_only},
    {'name': '99.co', 'post_type': '99co', 'number_fmt': fmt_plus},
    {'name': 'Beli Rumah', 'post_type': 'belirumahco', 'number_fmt': fmt_plus},
    {'name': 'Fastwork', 'post_type': 'fastworkid', 'number_fmt': fmt_08},
    {'name': 'Beautyhaul', 'post_type': 'beautyhaul', 'number_fmt': fmt_phone_only},
    {'name': 'Hainaya', 'post_type': 'hainaya', 'number_fmt': fmt_phone_only},
    {'name': 'MinumYukKaka', 'post_type': 'minumyukkaka', 'number_fmt': fmt_08},
    {'name': 'SIDEMANG', 'post_type': 'sidemang', 'number_fmt': fmt_08},
    {'name': 'LaporMasBup', 'post_type': 'lapormasbup', 'number_fmt': fmt_08},
    {'name': 'PTSP Kemenag', 'post_type': 'ptspkemenag', 'number_fmt': fmt_08},

    # ========== JSON HANDLER (dari kode kedua) ==========
    {
        'name': 'Pinhome',
        'post_type': 'json',
